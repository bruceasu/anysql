...
public final class TextUtils
{
    ...
    public static final Vector getFields(String paramString1,
                                         String paramString2,
                                         String paramString3)
    {
        ...
        while (localFieldTokenizer.hasMoreTokens()) {
            ...
            if ((i != 0) && ((!((String) localObject).endsWith(paramString3)) || (
                    ((String) localObject).length() == paramString3.length()))) {
                continue;
            }
            if (((String) localObject).endsWith(paramString3)) {
                i = 0;
            }
            if ((((String) localObject).length() > paramString3.length()) && (((String) localObject)
                    .startsWith(paramString3)) && (((String) localObject).endsWith(paramString3))) {
    ...
    public static final Vector getWords(String cmdLine, String[] splitters, String escape)
    {
        ...
        while (localCommandTokenizer.hasMoreTokens()) {
            ...
            if ((i != 0) && (((!((String) localObject).endsWith(escape)) && (!((String) localObject)
                    .endsWith(escape + "\n"))) || (((String) localObject).length()
                    == escape.length()))) {
                continue;
            }
            if ((((String) localObject).endsWith(escape)) || (((String) localObject).endsWith(
                    escape + "\n"))) {
                i = 0;
            }
            if ((((String) localObject).length() > escape.length())
                    && (((String) localObject).startsWith(escape)) && (
                    (((String) localObject).endsWith(escape)) || (((String) localObject).endsWith(
                            escape + "\n")))) {
                localObject = ((String) localObject).substring(escape.length());
                if ((((String) localObject).length() >= escape.length())
                        && (((String) localObject).endsWith(escape))) {
                    localObject = ((String) localObject).substring(0,
                            ((String) localObject).length() - escape.length());
                } else if ((((String) localObject).length() >= escape.length())
                        && (((String) localObject).endsWith(escape + "\n"))) {
                    localObject = ((String) localObject).substring(0,
                            ((String) localObject).length() - escape.length() - 1);
                }
            }
            if (i == 0) {
                if (((String) localObject).endsWith("\n")) {
                    localObject = ((String) localObject).substring(0,
                            ((String) localObject).length() - 1);
                }
